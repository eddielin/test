package com.alipay.jstorm.util;
...
//            Class configClass = SystemConfig.class;//Class.forName("com.kkpush.util.SystemConfig");
        ...
        {
    		LOG.error("load with ClassLoader error", e);
        }
